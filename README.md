...
Add PDF, TXT, and CSV files into the `data/` directory or upload them in Google Colab.
...
The system emphasizes modularity, scalability, and hallucination prevention while maintaining a clean architecture and practical implementation.
